...
export const initialLeads: Lead[] = [
  // Đang chăm sóc
  { id: '4', code: 'IKG-260320-004', status: 'dang_cham_soc', source: 'Website', senderName: 'Phạm Đức Dũng', senderPhone: '0934567890', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Nakamura Hana', receiverAddress: 'Fukuoka, Hakata-ku, 2-3-4', receiverPhone: '080-3333-4444', itemType: 'Đồ điện tử', weightKg: 8, dimL: 60, dimW: 40, dimH: 30, totalFee: 935000, createdAt: '2026-03-20', assignedTo: 'Trần Thị Mai', collectStatus: 'Đang gom đơn', statusHistory: [{ status: 'lead_moi', date: '2026-03-21' }, { status: 'dang_cham_soc', date: '2026-03-22' }] },
  { id: '5', code: 'IKG-260321-005', status: 'dang_cham_soc', source: 'Facebook', senderName: 'Hoàng Thị Em', senderPhone: '0945678901', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Suzuki Ren', receiverAddress: 'Sapporo, Chuo-ku, 5-6-7', receiverPhone: '090-5555-6666', itemType: 'Thực phẩm', weightKg: 12, dimL: 50, dimW: 40, dimH: 35, totalFee: 1395000, createdAt: '2026-03-21', assignedTo: 'Trần Thị Mai', collectStatus: 'Đợi gửi hàng', statusHistory: [{ status: 'lead_moi', date: '2026-03-22' }, { status: 'dang_cham_soc', date: '2026-03-23' }] },
  { id: '6', code: 'IKG-260322-006', status: 'dang_cham_soc', source: 'Zalo', senderName: 'Vũ Quốc Phong', senderPhone: '0956789012', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Watanabe Mei', receiverAddress: 'Kobe, Nada-ku, 8-9-10', receiverPhone: '070-7777-8888', itemType: 'Khác', weightKg: 6, dimL: 45, dimW: 35, dimH: 25, totalFee: 705000, createdAt: '2026-03-22', assignedTo: 'Trần Thị Mai', collectStatus: 'Đợi gửi hàng', statusHistory: [{ status: 'lead_moi', date: '2026-03-23' }, { status: 'dang_cham_soc', date: '2026-03-24' }] },
  
  // Lead mới
  { id: '1', code: 'IKG-260325-001', status: 'lead_moi', source: 'Facebook', senderName: 'Nguyễn Văn An', senderPhone: '0901234567', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Tanaka Yuki', receiverAddress: 'Tokyo, Shinjuku-ku, 1-2-3', receiverPhone: '080-1234-5678', itemType: 'Thực phẩm', weightKg: 5, dimL: 40, dimW: 30, dimH: 20, totalFee: 590000, createdAt: '2026-03-25', assignedTo: 'Trần Thị Mai', consultStatus: 'Đã liên hệ', statusHistory: [{ status: 'lead_moi', date: '2026-03-25' }] },
  { id: '2', code: 'IKG-260326-002', status: 'lead_moi', source: 'Zalo', senderName: 'Trần Thị Bình', senderPhone: '0912345678', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Sato Kenji', receiverAddress: 'Osaka, Namba, 4-5-6', receiverPhone: '090-8765-4321', itemType: 'Quần áo', weightKg: 3, dimL: 50, dimW: 40, dimH: 30, totalFee: 345000, createdAt: '2026-03-26', assignedTo: 'Trần Thị Mai', consultStatus: 'Chưa liên hệ', statusHistory: [{ status: 'lead_moi', date: '2026-03-26' }] },
  { id: '3', code: 'IKG-260327-003', status: 'lead_moi', source: 'TikTok', senderName: 'Lê Minh Châu', senderPhone: '0923456789', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Yamamoto Aoi', receiverAddress: 'Nagoya, Chikusa-ku, 7-8-9', receiverPhone: '070-1111-2222', itemType: 'Mỹ phẩm', weightKg: 2, dimL: 30, dimW: 20, dimH: 15, totalFee: 230000, createdAt: '2026-03-27', assignedTo: 'Trần Thị Mai', consultStatus: 'Đã gọi lần 1', statusHistory: [{ status: 'lead_moi', date: '2026-03-27' }] },
  
  // Đã chốt đơn
  { id: '19', code: 'IKG-260328-019', status: 'da_chot_don', source: 'Website', senderName: 'Hoàng Kim Hạnh', senderPhone: '0908112233', senderAddress: 'Hà Nội, Việt Nam', receiverName: 'Sasaki Yui', receiverAddress: 'Chiba, Mihama-ku, 1-2', receiverPhone: '080-4455-6677', itemType: 'Quần áo', weightKg: 15, dimL: 55, dimW: 40, dimH: 35, totalFee: 1750000, createdAt: '2026-03-28', assignedTo: 'Nguyễn Thanh Tùng', isPaid: true, statusHistory: [{ status: 'lead_moi', date: '2026-03-28' }, { status: 'dang_cham_soc', date: '2026-03-29' }, { status: 'da_chot_don', date: '2026-03-30' }] },
  { id: '20', code: 'IKG-260329-020', status: 'da_chot_don', source: 'Zalo', senderName: 'Lý Quốc Bảo', senderPhone: '0919223344', senderAddress: 'Đà Nẵng, Việt Nam', receiverName: 'Abe Kaito', receiverAddress: 'Saitama, Omiya-ku, 3-4', receiverPhone: '090-5566-7788', itemType: 'Thực phẩm', weightKg: 7, dimL: 40, dimW: 30, dimH: 25, totalFee: 820000, createdAt: '2026-03-29', assignedTo: 'Trần Thị Mai', isPaid: false, statusHistory: [{ status: 'lead_moi', date: '2026-03-29' }, { status: 'dang_cham_soc', date: '2026-03-30' }, { status: 'da_chot_don', date: '2026-04-01' }] },
  
  // Vận chuyển nội địa
  { id: '7', code: 'IKG-260315-007', status: 'van_chuyen_noi_dia', source: 'TikTok', senderName: 'Đặng Văn Giang', senderPhone: '0967890123', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Ito Sota', receiverAddress: 'Yokohama, Nishi-ku, 1-1-1', receiverPhone: '080-9999-0000', itemType: 'Quần áo', weightKg: 10, dimL: 55, dimW: 45, dimH: 30, totalFee: 1165000, createdAt: '2026-03-15', assignedTo: 'Trần Thị Mai', statusHistory: [{ status: 'van_chuyen_noi_dia', date: '2026-03-19' }] },
  { id: '8', code: 'IKG-260316-008', status: 'van_chuyen_noi_dia', source: 'Khác', senderName: 'Bùi Thị Hoa', senderPhone: '0978901234', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Takahashi Yui', receiverAddress: 'Kyoto, Higashiyama-ku, 3-3-3', receiverPhone: '090-1212-3434', itemType: 'Mỹ phẩm', weightKg: 4, dimL: 35, dimW: 25, dimH: 20, totalFee: 460000, createdAt: '2026-03-16', assignedTo: 'Trần Thị Mai', statusHistory: [{ status: 'van_chuyen_noi_dia', date: '2026-03-20' }] },
  { id: '9', code: 'IKG-260317-009', status: 'van_chuyen_noi_dia', source: 'Facebook', senderName: 'Ngô Thanh Inh', senderPhone: '0989012345', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Kobayashi Riku', receiverAddress: 'Sendai, Aoba-ku, 5-5-5', receiverPhone: '070-5656-7878', itemType: 'Thực phẩm', weightKg: 15, dimL: 60, dimW: 50, dimH: 40, totalFee: 1750000, createdAt: '2026-03-17', assignedTo: 'Trần Thị Mai', statusHistory: [{ status: 'van_chuyen_noi_dia', date: '2026-03-21' }] },
  
  // Đang bay
  { id: '10', code: 'IKG-260310-010', status: 'dang_bay', source: 'Website', senderName: 'Lý Văn Khôi', senderPhone: '0990123456', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Yoshida Sakura', receiverAddress: 'Hiroshima, Minami-ku, 7-7-7', receiverPhone: '080-3434-5656', itemType: 'Đồ điện tử', weightKg: 7, dimL: 50, dimW: 35, dimH: 25, totalFee: 820000, carrier: 'EMS', trackingCode: 'EMS9988776655', shipDate: '2026-03-25', createdAt: '2026-03-10', assignedTo: 'Trần Thị Mai', statusHistory: [{ status: 'van_chuyen_noi_dia', date: '2026-03-12' }, { status: 'dang_bay', date: '2026-03-25' }] },
  { id: '11', code: 'IKG-260311-011', status: 'dang_bay', source: 'Zalo', senderName: 'Mai Thị Lan', senderPhone: '0901234568', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Kato Haruto', receiverAddress: 'Niigata, Chuo-ku, 2-2-2', receiverPhone: '090-7878-9090', itemType: 'Quần áo', weightKg: 9, dimL: 55, dimW: 40, dimH: 30, totalFee: 1050000, carrier: 'DHL', trackingCode: 'DHL5544332211', shipDate: '2026-03-26', hasIssue: true, issueReason: 'Lỗi vận chuyển', issueDesc: 'Thời tiết xấu, bay chậm 1 ngày', issueSolution: 'Thông báo khách hàng thông cảm', createdAt: '2026-03-11', assignedTo: 'Trần Thị Mai', statusHistory: [{ status: 'van_chuyen_noi_dia', date: '2026-03-13' }, { status: 'dang_bay', date: '2026-03-26' }] },
  { id: '12', code: 'IKG-260312-012', status: 'dang_bay', source: 'Facebook', senderName: 'Phan Quốc Minh', senderPhone: '0912345679', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Morita Aiko', receiverAddress: 'Okayama, Kita-ku, 4-4-4', receiverPhone: '070-2323-4545', itemType: 'Khác', weightKg: 20, dimL: 70, dimW: 50, dimH: 40, totalFee: 2330000, carrier: 'Sagawa', trackingCode: 'SGW1122334455', shipDate: '2026-03-27', createdAt: '2026-03-12', assignedTo: 'Trần Thị Mai', statusHistory: [{ status: 'van_chuyen_noi_dia', date: '2026-03-14' }, { status: 'dang_bay', date: '2026-03-27' }] },
  
  // Hoàn thành
  { id: '13', code: 'IKG-260301-013', status: 'hoan_thanh', source: 'TikTok', senderName: 'Đỗ Thị Ngọc', senderPhone: '0923456780', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Kimura Daiki', receiverAddress: 'Tokyo, Shibuya-ku, 9-9-9', receiverPhone: '080-6767-8989', itemType: 'Thực phẩm', weightKg: 6, dimL: 40, dimW: 30, dimH: 25, totalFee: 705000, carrier: 'EMS', trackingCode: 'EMS1111222233', shipDate: '2026-03-03', createdAt: '2026-03-01', assignedTo: 'Trần Thị Mai', 
    statusHistory: [
  ...
  { id: '15', code: 'IKG-260303-015', status: 'hoan_thanh', source: 'Khác', senderName: 'Cao Thị Quỳnh', senderPhone: '0945678902', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Honda Taro', receiverAddress: 'Nagoya, Nakamura-ku, 8-8-8', receiverPhone: '070-8989-0101', itemType: 'Quần áo', weightKg: 11, dimL: 55, dimW: 45, dimH: 35, totalFee: 1280000, carrier: 'Sagawa', trackingCode: 'SGW7777888899', shipDate: '2026-03-05', createdAt: '2026-03-03', assignedTo: 'Trần Thị Mai', 
    statusHistory: [
  ...
  { id: '16', code: 'IKG-260304-016', status: 'hoan_thanh', source: 'Facebook', senderName: 'Lê Thị Ry', senderPhone: '0956789013', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Matsuda Ken', receiverAddress: 'Sapporo, Toyohira-ku, 1-3-5', receiverPhone: '080-0202-0303', itemType: 'Đồ điện tử', weightKg: 5, dimL: 45, dimW: 30, dimH: 20, totalFee: 590000, carrier: 'EMS', trackingCode: 'EMS3333444455', shipDate: '2026-03-06', createdAt: '2026-03-04', assignedTo: 'Trần Thị Mai', 
    statusHistory: [
