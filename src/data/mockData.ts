...
export const initialLeads: Lead[] = [
  // Đang chăm sóc
  { id: '4', code: 'IKG-WEB-260320-004', status: 'cho_xac_nhan', source: 'Website', senderName: 'Phạm Đức Dũng', senderPhone: '0934567890', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Nakamura Hana', receiverAddress: 'Fukuoka, Hakata-ku, 2-3-4', receiverPhone: '080-3333-4444', itemType: 'Đồ điện tử', weightKg: 8, dimL: 60, dimW: 40, dimH: 30, totalFee: 935000, createdAt: '2026-03-20', statusHistory: [{ status: 'cho_xac_nhan', date: '2026-03-22' }] },
  { id: '5', code: 'IKG-FB-260321-005', status: 'cho_xac_nhan', source: 'Facebook', senderName: 'Hoàng Thị Em', senderPhone: '0945678901', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Suzuki Ren', receiverAddress: 'Sapporo, Chuo-ku, 5-6-7', receiverPhone: '090-5555-6666', itemType: 'Thực phẩm', weightKg: 12, dimL: 50, dimW: 40, dimH: 35, totalFee: 1395000, createdAt: '2026-03-21', statusHistory: [{ status: 'cho_xac_nhan', date: '2026-03-23' }] },
  { id: '6', code: 'IKG-ZL-260322-006', status: 'cho_xac_nhan', source: 'Zalo', senderName: 'Vũ Quốc Phong', senderPhone: '0956789012', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Watanabe Mei', receiverAddress: 'Kobe, Nada-ku, 8-9-10', receiverPhone: '070-7777-8888', itemType: 'Khác', weightKg: 6, dimL: 45, dimW: 35, dimH: 25, totalFee: 705000, createdAt: '2026-03-22', statusHistory: [{ status: 'cho_xac_nhan', date: '2026-03-24' }] },
  
  // Lead mới
  { id: '1', code: 'IKG-FB-260325-001', status: 'lead_moi', source: 'Facebook', senderName: 'Nguyễn Văn An', senderPhone: '0901234567', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Tanaka Yuki', receiverAddress: 'Tokyo, Shinjuku-ku, 1-2-3', receiverPhone: '080-1234-5678', itemType: 'Thực phẩm', weightKg: 5, dimL: 40, dimW: 30, dimH: 20, totalFee: 590000, createdAt: '2026-03-25', statusHistory: [{ status: 'lead_moi', date: '2026-03-25' }] },
  ...
  { id: '8', code: 'IKG-K-260316-008', status: 'van_chuyen_noi_dia', source: 'Khác', senderName: 'Bùi Thị Hoa', senderPhone: '0978901234', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Takahashi Yui', receiverAddress: 'Kyoto, Higashiyama-ku, 3-3-3', receiverPhone: '090-1212-3434', itemType: 'Mỹ phẩm', weightKg: 4, dimL: 35, dimW: 25, dimH: 20, totalFee: 460000, createdAt: '2026-03-16', statusHistory: [{ status: 'van_chuyen_noi_dia', date: '2026-03-20' }] },
