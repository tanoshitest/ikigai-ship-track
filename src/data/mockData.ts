...
export const initialLeads: Lead[] = [
  // Đang chăm sóc
  { id: '4', code: 'IKG-WEB-260320-004', status: 'dang_cham_soc', source: 'Website', senderName: 'Phạm Đức Dũng', senderPhone: '0934567890', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Nakamura Hana', receiverAddress: 'Fukuoka, Hakata-ku, 2-3-4', receiverPhone: '080-3333-4444', itemType: 'Đồ điện tử', weightKg: 8, dimL: 60, dimW: 40, dimH: 30, totalFee: 935000, createdAt: '2026-03-20', assignedTo: 'Trần Thị Mai', collectStatus: 'Đang gom đơn', statusHistory: [{ status: 'lead_moi', date: '2026-03-21' }, { status: 'dang_cham_soc', date: '2026-03-22' }] },
  { id: '5', code: 'IKG-FB-260321-005', status: 'dang_cham_soc', source: 'Facebook', senderName: 'Hoàng Thị Em', senderPhone: '0945678901', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Suzuki Ren', receiverAddress: 'Sapporo, Chuo-ku, 5-6-7', receiverPhone: '090-5555-6666', itemType: 'Thực phẩm', weightKg: 12, dimL: 50, dimW: 40, dimH: 35, totalFee: 1395000, createdAt: '2026-03-21', assignedTo: 'Trần Thị Mai', collectStatus: 'Đợi gửi hàng', statusHistory: [{ status: 'lead_moi', date: '2026-03-22' }, { status: 'dang_cham_soc', date: '2026-03-23' }] },
  { id: '6', code: 'IKG-ZL-260322-006', status: 'dang_cham_soc', source: 'Zalo', senderName: 'Vũ Quốc Phong', senderPhone: '0956789012', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Watanabe Mei', receiverAddress: 'Kobe, Nada-ku, 8-9-10', receiverPhone: '070-7777-8888', itemType: 'Khác', weightKg: 6, dimL: 45, dimW: 35, dimH: 25, totalFee: 705000, createdAt: '2026-03-22', assignedTo: 'Trần Thị Mai', collectStatus: 'Đợi gửi hàng', statusHistory: [{ status: 'lead_moi', date: '2026-03-23' }, { status: 'dang_cham_soc', date: '2026-03-24' }] },
  
  // Lead mới
  { id: '1', code: 'IKG-FB-260325-001', status: 'lead_moi', source: 'Facebook', senderName: 'Nguyễn Văn An', senderPhone: '0901234567', senderAddress: 'Hồ Chí Minh, Việt Nam', receiverName: 'Tanaka Yuki', receiverAddress: 'Tokyo, Shinjuku-ku, 1-2-3', receiverPhone: '080-1234-5678', itemType: 'Thực phẩm', weightKg: 5, dimL: 40, dimW: 30, dimH: 20, totalFee: 590000, createdAt: '2026-03-25', assignedTo: 'Trần Thị Mai', consultStatus: 'Đã liên hệ', statusHistory: [{ status: 'lead_moi', date: '2026-03-25' }] },
